...
public enum ConfigurationController {
    ...
    public ListenableFuture<Integer> initXmlRegexConfiguration(InputStream configFileStream) {
    ...
    public ListenableFuture<Integer> initXmlGUIConfiguration(InputStream configFileStream) {
