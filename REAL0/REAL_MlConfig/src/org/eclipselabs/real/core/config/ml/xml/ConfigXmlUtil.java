...
import org.eclipselabs.real.core.config.ml.regex.constructor.IDTIntervalAcceptanceConstructor;
...
import org.eclipselabs.real.core.config.ml.regex.constructor.ISOConstructor;
import org.eclipselabs.real.core.config.ml.regex.xml.constructor.LinkedRealRegexXmlConstructorImpl;
import org.eclipselabs.real.core.config.ml.regex.xml.constructor.RealRegexGroupXmlConstructorImpl;
import org.eclipselabs.real.core.config.ml.regex.xml.constructor.RealRegexXmlConstructorImpl;
import org.eclipselabs.real.core.config.ml.regex.xml.constructor.RegexXmlConstructorFactoryImpl;
import org.eclipselabs.real.core.config.ml.regex.xml.constructor.ReplaceableParamXmlConstructorImpl;
...
public class ConfigXmlUtil implements IConfigXmlConstants {
    ...
    public static List<IReplaceableParam<?>> collectReplaceParams(Node elem) {
        List<IReplaceableParam<?>> result = new ArrayList<>();
    ...
    public static List<IRealRegex> collectRegex(Node elem) {
        List<IRealRegex> result = new ArrayList<>();
    ...
    public static Map<String,IRealRegex> collectNamedRegex(Node elem) {
        Map<String,IRealRegex> result = new HashMap<>();
        if (elem.hasChildNodes()) {
            Node currNode = elem.getFirstChild();
            IRealRegex newRegex = null;
            Map<String,IRealRegexGroup> groupMap = new HashMap<>();
    ...
    public static void constructKeyedSO(IKeyedSearchObject<?, ?> keyedSO, Element soNode) {
        ...
        if ((allDateInfos != null) && (!allDateInfos.isEmpty())) {
            keyedSO.setDateInfos(allDateInfos);
        } else {
    ...
    public static void constructRefKeyedSO(
        ...
        // tags
        Map<String,String> soTagsMap = new HashMap<>();
        ...
        // ref tags
        Map<String,String> refTagsMap = new HashMap<>();
